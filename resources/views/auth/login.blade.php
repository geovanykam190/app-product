    ...
    <div class="container-fluid" id="form-container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-5 col-md-5 col-xs-12 loginArea">
                ...
                <div id="formLogin">
                    <form id="formulario" action="{{route('login')}}" method="post" class="row justify-content-center">
                        @csrf
                        ...
                        <div class="form-group col-12 col-md-12 firstDiv">
                        ...
                        <div class="form-group col-12 col-md-12">
                            ...
                            <span class="resetPass"><a href="{{route('reset')}}"> Esqueceu sua senha?</a></span>        
                        </div>

                        <div class="form-group col-12 col-md-12">
                            <div class=" justify-content-center">
                                <button type="submit" class="col-10 col-md-6 btn btn-primary btn-lg mt-5">Login</button>
                            </div>
                ...
                <div class="row justify-content-center align-items-end">
                    <div class="col-12">
                        <footer class="mt-auto footerLogin">
                        Sistema de Produtos LTDA © {{date('Y')}}
                        </footer>
